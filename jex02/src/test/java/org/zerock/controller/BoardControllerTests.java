...
public class BoardControllerTests {
	...
	public void testRegister() throws Exception {
		...
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/board/register")
				// POST 방식으로 데이터 전달
				.param("title", "테스트 새글 제목")		// 전달해야 하는 파라미터 지정
	...
	*/
	...
	// 삭제 전 데이터베이스에 게시물 번호 확인할 것
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/board/remove").param("bno", "22")).andReturn().getModelAndView().getViewName();
