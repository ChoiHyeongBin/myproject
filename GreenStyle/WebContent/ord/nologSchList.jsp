...
#tab { position:absolute; top:140px; left:350px; }
#status {
...
#completeTxt { font-size:30px; margin:30px 0 40px 445px; height:70px; width:500px; }
#under { position:relative; top:20px;}
#completeTxt2 { margin:30px 0 30px 245px; }
#orderBtn { width:1200px; text-align:center; height:100px; position:relative; left:300px; }
...
<!-- 상태바 -->
<div id="status">
	<h2 id=""><span id="subStatus">주문내역</span></h2>
</div>
<div id="frm"><br /><br /><br />
<hr id="under" width="1200" color="black"><br />
<br />
<!-- 테이블1 시작 -->
<table width="1200" id="tab" align="center">
<tr>
...
<tr>
	...
	<td width="*">
		...
		총 상품금액 : <span id="price"><%=odi.getOd_price()%></span>원<br />
...
<div id="orderBtn">
	<input type="button" name="" id="continueBtn" value="쇼핑 계속하기" style="width:200px; height:60px;" onclick="location.href='main.jsp'" />
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
