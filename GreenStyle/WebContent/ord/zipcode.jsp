...
<style>
#box { width:370px; height:150px; border:1px solid black; padding:5px; text-align:center; }
...
<script>
	function zipApply() {
		...
		opener.frmOrder.rzip.value = zip;
		opener.frmOrder.raddr1.value = addr;
		opener.frmOrder.raddr2.value = addrDetail;
