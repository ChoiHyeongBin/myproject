...
public class NoticeInfo {
	private int nl_num, nl_read, al_num;
	private String nl_title, nl_content, nl_kind, nl_date;
	private String nl_isview, al_name;
	...
	public int getNl_num() {
		return nl_num;
	}
	public void setNl_num(int nl_num) {
		this.nl_num = nl_num;
	}
